...
const WRONG_ISIN_TS_CP = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const res = await axios.get(`${URL}/api/v1/isin/compareIsinTS`, {
          params: { page, limit },
        ...
        <section className="container px-4 mx-auto">
          <div className="flex flex-col items-center justify-center gap-x-3 mt-5">
            <h1 className="text-lg font-medium text-gray-800">
              Wrong ISIN Between prod_company_profile & Typesense
            </h1>
          </div>
...
export default WRONG_ISIN_TS_CP;
